...
public class BlueprintGenerator {
    ...
    private static void fixUndergroundBelts(Blueprint blueprint) {
        ...
        for (UndergroundBelt oldUndergroundBelt : undergroundBelts) {
            ...
            if (isOrphan(blueprint, oldUndergroundBelt)) {
                ...
                int offset = 0;
                Direction searchDirection = oldUndergroundBelt.isInput() ? oldUndergroundBelt.getDirection() : oldUndergroundBelt.getDirection().getReversed();
    ...
    private static UndergroundBelt getOtherUndergroundHalf(Blueprint blueprint, UndergroundBelt undergroundBelt) {
        ...
        Int2 newPos;
        Direction searchDirection = undergroundBelt.isInput() ? undergroundBelt.getDirection() : undergroundBelt.getDirection().getReversed();
